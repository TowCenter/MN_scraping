"""
Articles Scraper for NPR Minneapolis

Target URL: https://www.npr.org/search/?query=minneapolis&page=1&sortType=byDate
...
GOOGLE_NEWS_RSS_URL = (
    ...
    "q=site:npr.org+minneapolis&hl=en-US&gl=US&ceid=US:en"
)
